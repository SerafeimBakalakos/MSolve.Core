namespace MGroup.MSolve.Numerics.Interpolation
{
	...
	public class InterpolationShell8Cohesive : IsoparametricInterpolation2DBase
	{
		...
		private readonly ConcurrentDictionary<IQuadrature2D, IReadOnlyList<Matrix>> cachedN3AtGPs;
		...
		/// <summary>
		/// See <see cref="IIsoparametricInterpolation2D.CheckElementNodes(IReadOnlyList{INode})"/>
		/// </summary>
		...
		public override IInverseInterpolation2D CreateInverseMappingFor(IReadOnlyList<INode> nodes)
