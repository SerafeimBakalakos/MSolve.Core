namespace MGroup.MSolve.Numerics.Interpolation
{
	...
	public abstract class IsoparametricInterpolation3DBase : IIsoparametricInterpolation3D
	{
		...
		/// <summary>
		/// See <see cref="IIsoparametricInterpolation3D.CreateInverseMappingFor(IReadOnlyList{INode})"/>.
		/// </summary>
		public abstract IInverseInterpolation3D CreateInverseMappingFor(IReadOnlyList<INode> nodes);

		/// <summary>
		/// See <see cref="IIsoparametricInterpolation3D.EvaluateAllAt(IReadOnlyList{INode}, NaturalPoint)"/>.
		/// </summary>
		public EvalInterpolation3D EvaluateAllAt(IReadOnlyList<INode> nodes, NaturalPoint naturalPoint)
		{
		...
		/// <summary>
		/// See <see cref="IIsoparametricInterpolation3D.EvaluateAllAtGaussPoints(IReadOnlyList{INode}, IQuadrature3D)"/>
		/// </summary>
		public IReadOnlyList<EvalInterpolation3D> EvaluateAllAtGaussPoints(IReadOnlyList<INode> nodes, IQuadrature3D quadrature)
		{
		...
		/// <summary>
		/// See <see cref="IIsoparametricInterpolation3D.TransformNaturalToCartesian(IReadOnlyList{INode}, NaturalPoint)"/>.
		/// </summary>
